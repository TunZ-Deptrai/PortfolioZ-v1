...
const StyleLoader = () => (
  <style dangerouslySetInnerHTML={{ __html: `
    ...
    .hero-title-kern-close {
      display: inline-block;
      margin-right: -0.018em;
    }

    .hero-title-kern-pair {
      display: inline-block;
      margin-left: -0.02em;
      margin-right: 0;
    }
    ...
    <section id="hero" className="relative min-h-screen flex flex-col justify-center items-center px-6 sm:px-12 pt-28 pb-20 overflow-hidden z-10 text-white">
      ...
      <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
        ...
        <h1 className="font-headings font-black text-5xl sm:text-7xl md:text-[6.5rem] lg:text-[7.5rem] tracking-tight leading-none uppercase relative select-none mb-4">
          <span className="hero-title-word hero-title-tight hero-title-main text-white"><span className="hero-title-kern-close">H</span><span className="hero-title-kern-close">O</span>ANG</span>
          <span className="hero-title-word hero-title-accent-premium"><span className="hero-title-tight">TU<span className="hero-title-kern-pair">A</span>N</span><span className="hero-title-z">Z</span></span>
        </h1>
